                                    ...
                                    <table class="table table-striped table-hover table-borderless table-vcenter fs-sm mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-none d-sm-table-cell text-center">
                                                <img class="img-avatar img-avatar32" :src="'/_themes/OneUI/assets/media/avatars/avatar12.jpg'" alt="">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-none d-sm-table-cell text-center">
                                                <img class="img-avatar img-avatar32" :src="'/_themes/OneUI/assets/media/avatars/avatar7.jpg'" alt="">
                                            </td>
                                            <td class="fw-semibold">
                                                Amber Harvey                </td>
                                            <td class="d-none d-sm-table-cell text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-none d-sm-table-cell text-center">
                                                <img class="img-avatar img-avatar32" :src="'/_themes/OneUI/assets/media/avatars/avatar9.jpg'" alt="">
                                            </td>
                                            <td class="fw-semibold">
                                                Albert Ray                </td>
                                            <td class="d-none d-sm-table-cell text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-none d-sm-table-cell text-center">
                                                <img class="img-avatar img-avatar32" :src="'/_themes/OneUI/assets/media/avatars/avatar1.jpg'" alt="">
                                            </td>
                                            <td class="fw-semibold">
                                                Alice Moore                </td>
                                            <td class="d-none d-sm-table-cell text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-none d-sm-table-cell text-center">
                                                <img class="img-avatar img-avatar32" :src="'/_themes/OneUI/assets/media/avatars/avatar11.jpg'" alt="">
                                            </td>
                                            <td class="fw-semibold">
                                                Jack Estrada                </td>
                                            <td class="d-none d-sm-table-cell text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-none d-sm-table-cell text-center">
                                                <img class="img-avatar img-avatar32" :src="'/_themes/OneUI/assets/media/avatars/avatar3.jpg'" alt="">
                                            </td>
                                            <td class="fw-semibold">
                                                Amber Harvey                </td>
                                            <td class="d-none d-sm-table-cell text-center">
...
// import {umdPlugin} from '/_themes/js/plugins/chart.js/chart.umd.js';
// import {dasboardPlugin} from '/_themes/js/pages/be_pages_dashboard_v1.min.js';
export default {
    name: 'Dashboard',
    components:{
        TheHeader,
